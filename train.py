...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/accModels/yolov5xP2CBAM-ECA.yaml', help='model.yaml path')
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=1200, help='train, val image size (pixels)')
